/*
  ...
  - Added the required column `storeDescription` to the `BusinessRuleset` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_BusinessRuleset" ("createdAt", "id", "keywords", "maxAltDescLength", "maxDescriptionLength", "maxTitleLength", "minDescriptionLength", "minImages", "minTitleLength", "productAltImageRule", "productDescriptionRule", "productDescriptionTemplate", "productImageRule", "productNameRule", "productTagRule", "productVariantRule", "requiresAltText", "shop", "updatedAt") SELECT "createdAt", "id", "keywords", "maxAltDescLength", "maxDescriptionLength", "maxTitleLength", "minDescriptionLength", "minImages", "minTitleLength", "productAltImageRule", "productDescriptionRule", "productDescriptionTemplate", "productImageRule", "productNameRule", "productTagRule", "productVariantRule", "requiresAltText", "shop", "updatedAt" FROM "BusinessRuleset";
